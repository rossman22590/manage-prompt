      ...
      return [
        {
          ...
          current: path === `/agents/${params.agentId}`,
        },
        {
          name: "Edit",
          href: `/agents/${params.agentId}/edit`,
          current: path === `/agents/${params.agentId}/edit`,
        },
        {
          name: "Usage",
          href: `/agents/${params.agentId}/usage`,
          current: path === `/agents/${params.agentId}/usage`,
        },
      ];
    }
    const base = [
